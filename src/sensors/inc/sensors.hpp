...
public:
    ...
    // Overload used for testing: push both FromData into fd stack and a cv::Mat into display stack
    template<class ...Args>
    void refreshImage(LfStack<FromData> &fd, LfStack<cv::Mat> &display, Args &&...args);
protected:
